...
Fully integrating constraints into an object-oriented language demands for dealing with the complex type structure of these languages. Integrating constraints in object-oriented languages has received a substantial amount of interest.
